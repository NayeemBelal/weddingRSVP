...
const fadeUp = (delay = 0) => ({
  ...
  visible: { opacity: 1, y: 0, transition: { duration: 0.9, ease: [0.25, 0.1, 0.25, 1], delay } },
})
            ...
            <AnimatePresence mode="wait">
              {!showRsvp ? (
                ...
                >
                  ...
                  <motion.p className="invite-tagline" variants={fadeUp(0.55)}>
                    ...
                    {!submitted ? (
                      ...
                      >
                        ...
                        {[
                          ...
                          { name: 'guests', label: 'Number of Guests', type: 'number', placeholder: '1' },
                      ...
                      <motion.div
                        ...
                        transition={{ duration: 0.6, ease: [0.25, 0.1, 0.25, 1] }}
                      >
                        <img src="/bismillah.png" alt="" className="bismillah bismillah-sm" />
                        <p className="thanks-heading">Jazakallahu Khayran</p>
                        <p className="thanks-msg">
                          We look forward to celebrating with you,<br />{form.name}.
                        </p>
                        <p className="thanks-detail">
                          August 29, 2026 · 11 AM<br />East Plano Islamic Center
                        </p>
                      </motion.div>
                    )}
                  </AnimatePresence>
